...
// ── Resolve action-detection backend URL ─────────────────────────────────────
const resolveActionApiUrl = () => {
  const envUrl = process.env.EXPO_PUBLIC_ACTION_DETECTION_API_URL;
...
const ACTION_API_URL = resolveActionApiUrl();
