 ...
 */
export const LetterPracticeScreen: React.FC = () => {
    // ========================================================================
    // HELPER FUNCTIONS
    // ========================================================================
        ...
        try {
            ...
            if (result.shouldAccept) {
                ...
                await SessionTracker.recordAttempt(
                    'letter_practice', targetLetter, result.letter || targetLetter, true, `Letter: ${targetLetter}`
                );
            } else {
                ...
                await SessionTracker.recordAttempt(
                    'letter_practice', targetLetter, result.letter || '?', false, `Letter: ${targetLetter}`
                );
            }
        } catch (error) {
    ...
    return (
        <SafeAreaView style={styles.container} edges={['bottom']}>
            ...
            <FeedbackCard
                ...
                autoDismissMs={1200}  // 1.2 seconds
            />
        </SafeAreaView>
    );
};
