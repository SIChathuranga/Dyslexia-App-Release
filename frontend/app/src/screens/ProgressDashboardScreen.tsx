...
const AccuracyRing: React.FC<{
    ...
    label?: string;
    sublabel?: string;
}> = ({ percentage, size, strokeWidth, color, label, sublabel }) => {
            ...
            <View style={[
                ...
                <Svg width={size} height={size}>
                    ...
                    <Circle
                        ...
                        cy={size / 2}
                        r={radius}
                        stroke={DASHBOARD_COLORS.ringBg}
                ...
                {data.map((item, index) => {
                    ...
                    return (
                        <View key={index} style={barChartStyles.barWrapper}>
                            ...
                            {hasData && (
                                <Text style={barChartStyles.barValue}>
 ...
 */
const TrendBadge: React.FC<{ trend: 'improving' | 'stable' | 'declining' }> = ({ trend }) => {
    const config = {
    ...
    return (
        <View style={[trendStyles.badge, { backgroundColor: c.color + '30' }]}>
 ...
 */
const SuggestionCard: React.FC<{ suggestion: ParentSuggestion }> = ({ suggestion }) => {
    const bgColors = {
    ...
    return (
        <View style={[suggestionStyles.card, { backgroundColor: bgColors[suggestion.category] }]}>
            ...
            {suggestion.relatedActivity && (
                <View style={suggestionStyles.activityTag}>
            ...
            >
                ...
                {activeTab === 'overview' ? (
                    <>
                        ...
                        <View style={styles.overviewCard}>
                            ...
                            <View style={styles.overviewBody}>
                                <AccuracyRing
                                    percentage={analysis.overallAccuracy}
                                    size={120}
                                    strokeWidth={10}
                        ...
                        <View style={styles.sectionCard}>
                            ...
                            <View style={styles.activityGrid}>
                                {analysis.activityStats.map((stat) => (
                                    <View key={stat.activity} style={styles.activityCard}>
                                        <View style={[
                                        ...
                                        <View style={styles.activityBody}>
                                            <AccuracyRing
                                                ...
                                                size={70}
                                                strokeWidth={7}
                                                color={ACTIVITY_COLORS[stat.activity]}
                                            />
                                            ...
                                            <View style={styles.activityMeta}>
                                                ...
                                                {stat.totalAttempts > 0 && (
                                                    <TrendBadge trend={stat.recentTrend} />
                                                )}
                                                {stat.totalAttempts > 0 && (
                        ...
                        <View style={styles.sectionCard}>
                            ...
                            <WeeklyBarChart
                                data={analysis.weeklyProgress.map(w => ({
                                    label: w.weekLabel,
                                    value: w.accuracy,
                            ...
                            <View style={styles.weeklyStats}>
                                {analysis.weeklyProgress.filter(w => w.totalAttempts > 0).length > 0 && (
                        ...
                        {/* ============================================== */}
                        {analysis.confusionMatrix.length > 0 && (
                            <View style={styles.sectionCard}>
                                ...
                                {analysis.confusionMatrix.slice(0, 8).map((item, index) => (
                                    <View key={index} style={styles.confusionRow}>
                        ...
                        <View style={styles.sectionCard}>
                            ...
                            {analysis.activityStats
                                ...
                                .map((stat) => {
                                    ...
                                    return (
                                        <View key={stat.activity} style={styles.responseRow}>
                        ...
                        <View style={styles.dataManagement}>
                            <TouchableOpacity
                                style={styles.demoButtonSmall}
                                onPress={handleGenerateDemo}
                            >
                                <Text style={styles.demoButtonSmallText}>🎲 Reload Demo Data</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                style={[styles.demoButtonSmall, styles.clearButton]}
                    ...
                    <>
                        ...
                        {analysis.activityStats.filter(s => s.totalAttempts > 0).length > 0 && (
                            <View style={styles.strengthWeaknessCard}>
                                {/* Strongest */}
                                {(() => {
