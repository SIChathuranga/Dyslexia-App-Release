 ...
 */
export const preprocessDrawing = async (paths: string[]): Promise<tf.Tensor> => {
 ...
 */
export const loadModel = async (modelJson: any, modelWeights: any): Promise<tf.LayersModel | null> => {
    try {
        await tf.ready();
