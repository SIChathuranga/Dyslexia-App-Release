...
let digitModelInfo: DigitModelInfo | null = null;
 ...
 */
export const loadMathModel = async (): Promise<void> => {
 ...
 */
export const isDigitBackendConnected = (): boolean => {
    return digitBackendConnected;
};

/**
 * Prediction result including top alternatives for lenient matching
 */
 ...
 */
export const predictDigitFromBase64 = async (
    base64Image: string
 ...
 */
export const isDigitInPredictions = (target: string, prediction: DigitPrediction): boolean => {
 ...
 */
export const predictEquation = async (
    paths: string[]
): Promise<string> => {
 ...
 */
export const getDigitModelInfoCached = (): DigitModelInfo | null => {
