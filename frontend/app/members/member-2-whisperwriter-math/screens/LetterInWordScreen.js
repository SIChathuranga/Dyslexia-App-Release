 ...
 */
export const LetterInWordScreen = () => {
    // ========================================================================
    // HELPER FUNCTIONS
    // ========================================================================
    /**
    ...
    const speakChallenge = () => {
        ...
        speak(`What is the ${ordinalWord} letter in ${numberEntry.word}? ` +
            `Spelled: ${spelledWord}`);
    };
    // ========================================================================
    // EVENT HANDLERS
    ...
    const handleCheck = async () => {
        ...
        try {
            ...
            const result = await predictLetterDyslexiaFriendlyFromBase64(base64Image, challenge.correctLetter);
            ...
            if (isCorrect) {
                ...
                await SessionTracker.recordAttempt('letter_hunt', expectedLetter, predictedLetter, true, `Word: ${challenge.numberEntry.word}, Position: ${challenge.position}`);
            }
            else {
                ...
                await SessionTracker.recordAttempt('letter_hunt', expectedLetter, predictedLetter, false, `Word: ${challenge.numberEntry.word}, Position: ${challenge.position}`);
            }
        }
        catch (error) {
    ...
    const handleNext = () => {
        ...
        while (newChallenge.numberEntry.word === challenge.numberEntry.word &&
    ...
    return (<SafeAreaView style={styles.container} edges={['bottom']}>
            ...
            return (<View key={index} style={styles.letterBoxWrapper}>
                ...
                <Text style={[
                        ...
                        { fontSize: letterFontSize }
                                ...
                                {isTarget && (<Text style={styles.targetArrow}>👆</Text>)}
                            </View>);
        })}
                </View>
            </View>
            ...
            {/* FEEDBACK OVERLAY */}
            {/* ============================================== */}
            <FeedbackCard message={feedback.message} type={feedback.type} visible={showFeedback} onDismiss={handleFeedbackDismiss} autoDismissMs={2500}/>
        </SafeAreaView>);
};
// ============================================================================
// STYLES
